...
# PART 1: Break up `daily_sales` in easy to understand lists `customers`, `sales`, and `thread_sold`.
# Step 1
...
# daily_transactions_split = [ i.split(";") for i in daily_transactions]    # using list comprehension instead
...
# PART 2: Determine the total values of the days
# step 13
total_sales = 0
# step 14
for i in sales:
